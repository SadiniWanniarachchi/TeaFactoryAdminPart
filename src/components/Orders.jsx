...
const Orders = () => {
    ...
    return (
        <div className="flex font-kulim">
            <Sidebar activated="order" />
            <div className="flex-1 flex flex-col">
                <Topbar />
                <main className="p-6 bg-white flex-1 font-kulim">
                    <header className="flex justify-between items-center">
                        <h1 className="text-3xl font-bold text-gray-800 mt-5 mb-8">Order Dashboard</h1>
                    </header>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-6">
                        {[
                            ...
                            <div key={index} className={`p-5 rounded-lg shadow-md flex items-center ${stat.color}`}>
                                <div className="text-green-900 text-2xl mr-4">{stat.icon}</div>
                                <div>
                                    <h3 className="text-lg font-semibold text-green-900">{stat.label}</h3>
                                    <p className="text-2xl font-bold text-green-900">{stat.count}</p>
                                </div>
                            </div>
                        ))}
                    </div>
